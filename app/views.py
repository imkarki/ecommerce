...
#     message = f"{total_amount}|{transaction_uuid}|{settings.ESEWA_MERCHANT_ID}|{request.build_absolute_uri('/payment/success/')}|{request.build_absolute_uri('/payment/fail/')}"
